...
# pooling last hidden state with a single FF
# input type: pure tensors
...
#mlp
class MLP(nn.Module): #多层
    def __init__(self, dims, act = None):
        super().__init__()
        dims_pairs = list(zip(dims[:-1], dims[1:])) ##妙。。。
        layers = []
