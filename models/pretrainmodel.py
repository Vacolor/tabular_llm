...
class BertBased(nn.Module):
    def __init__(
        self,
        *,
        categories, # tuple of dimensions of each categorial column
        num_continuous,
        #dim,
        #depth,
        #heads,
        ...
        if self.cont_embeddings == 'MLP':
            ...
            nfeats = self.num_categories + num_continuous # number of columns
    ...
    def forward(self, x_categ, x_cont = None):
        ...
        return self.transformer(x_categ, x_cont)